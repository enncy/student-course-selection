 ...
 * @author: enncy
 */
public class ManagerInsertDialog extends ManageDialog{


    public ManagerInsertDialog(String title, ServiceComponent serviceComponent, BaseObject defaultBaseObject) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
