...
import cn.enncy.scs.view.component.table.ScsTable;
...
public class CourseSelectionPanel extends ScsWhitePanel {
    ...
    public CourseSelectionPanel()  {
        ...
        int fieldsLength = ResultSetHandler.getBaseObjectFields(OptionalCourse.class).length;
        ...
        for (int i = 0; i < all.size(); i++) {
            ...
            Field[] declaredFields = ResultSetHandler.getBaseObjectFields(baseObject.getClass()) ;
